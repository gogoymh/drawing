...
for index in range(100,550,50):
    ...
    pathIn= "/home/compu/ymh/drawing/save/num_003/Drawing/bird_result/result_%04d/" % index
    pathOut = '/home/compu/ymh/drawing/save/num_003/Drawing/result_%04d.mp4' % index
    fps = 29.97
