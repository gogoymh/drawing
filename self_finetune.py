...
parser.add_argument("--n_epoch", type=int, default=250, help="Number of epoch")
...
parser.add_argument("--path2", type=str, default="/home/compu/ymh/drawing/dataset/num_004/mask_org", help="Main path")
...
model_name = os.path.join("/home/compu/ymh/drawing/save/num_003/Drawing/character", "self_sup.pth")
